...
pub mod desktop_web_components {
    ...
    #[component]
    fn ContactItem(contact: Topic, on_select: Signal<Option<Topic>>) -> Element {
        ...
        rsx! {
            div {
                ...
                onclick: move |_| {
                    on_select.set(Some(contact.clone()));
                },
    ...
    #[component]
    fn Chat(topic: Signal<Topic>) -> Element {
        ...
        rsx! {
            div { class: "desktop-chat-window",
                div { class: "desktop-chat-header",
                    img { class: "desktop-contact-avatar", src: "{avatar_url}" }
                    h2 { class: "desktop-contact-name", "{topic.name}" }
                }
                ...
                div { class: "desktop-chat-input-area",
                    ...
                    button { class: "desktop-chat-send-button", "Send" }
                }
            }
        }
    }
